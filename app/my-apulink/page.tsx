...
// Dynamically import auth-dependent components to avoid SSR issues
const DashboardContent = dynamic(
  () => import('./DashboardContent').catch(() => {
    // If DashboardContent doesn't exist, return inline component
    return {
      default: function InlineDashboardContent({ user }: any) {
        ...
        // Import dashboard components inline
